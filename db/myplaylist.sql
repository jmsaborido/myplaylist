...
VALUES
    (1802, 'Chrono Trigger', 9, 1995),
    (481, 'Silent Hill 2', 13, 2001),
    (480, 'Silent Hill', 13, 1999),
    (482, 'Silent Hill 3', 13, 2003),
    (
        8222,
    ...
    (7334, 'Bloodborne', 11, 2015),
    (374, 'Metal Gear', 4, 1987),
    (377, 'Metal Gear 2: Solid Snake', 4, 1990),
    (375, 'Metal Gear Solid', 4, 1998),
    (
        376,
    ...
    (379, 'Metal Gear Solid 3: Snake Eater', 4, 2004),
    (
        380,
    ...
    (7091, 'MX vs. ATV Reflex', 2, 2009),
    (733, 'Grand Theft Auto: Vice City', 10, 2003),
    (
        3262,
    ...
    (2484, 'Pro Evolution Soccer 6', 5, 2005),
    (96, 'Need for Speed: Underground', 2, 2003),
    (20456, 'Resident Evil: Deadly Silence', 13, 2006),
    (97, 'Need for Speed: Underground 2', 2, 2004),
    (913, 'Tony Hawk''s Pro Skater 2', 3, 2000),
    (6692, 'Tony Hawk''s Pro Skater', 9, 1999),
    (24869, 'Resident Evil', 13, 2002),
    (98, 'Need for Speed: Most Wanted', 2, 2005),
    (7498, 'Tekken 7', 7, 2015),
    (
        3619,
    ...
    (1289, 'Ratchet & Clank', 8, 2002),
    (1770, 'Ratchet & Clank: Going Commando', 8, 2003),
    (47381, 'Dirt 3: Complete Edition', 2, 2015),
    (
        5328,
    ...
    (9806, 'Hyper Light Drifter', 6, 2016),
    (14593, 'Hollow Knight', 6, 2017),
    (
        1985,
    ...
    (1051, 'Mirror''s Edge', 8, 2008),
    (37, 'Dead Space', 13, 2008),
    (121, 'Minecraft', 12, 2011),
    (78153, 'Burnout Paradise Remastered', 2, 2018),
    (4006, 'Metal Gear Solid: Twin Snakes', 4, 2004),
    (25580, 'Forager', 12, 2019),
    (914, 'Tony Hawk''s Pro Skater 3', 3, 2001),
    (47325, 'Tony Hawk''s Pro Skater 2X', 3, 2001),
    (1577, 'Spyro 2', 8, 1999),
    (
        1026,
    ...
    (52200, 'Descenders', 3, 2018),
    (11065, 'Ratchet & Clank', 8, 2016),
    (25076, 'Red Dead Redemption 2', 10, 2018),
    (75449, 'Resident Evil 7: Biohazard', 13, 2017),
    (19686, 'Resident Evil 2', 13, 2019),
    (11233, 'What Remains of Edith Finch', 14, 2017),
    (9727, 'SOMA', 14, 2015),
    (7621, 'Rime', 8, 2017),
    (11156, 'Horizon Zero Dawn', 1, 2017),
    (19560, 'God Of War', 1, 2018),
    (19565, 'Marvel''s Spider-Man', 1, 2018),
    (87683, 'Spyro Reignited Trilogy', 8, 2019),
    (1075, 'Super Mario Sunshine', 8, 2002),
    (1103, 'Super Metroid', 6, 1994),
    (1107, 'Metroid: Zero Mission', 6, 2004),
    (1104, 'Metroid Fusion', 6, 2002),
    (1077, 'Super Mario Galaxy', 8, 2007),
    (1102, 'Metroid II: Return of Samus', 6, 2016),
    (26820, 'Blasphemous', 6, 2019),
    (96476, 'Horizon Chase Turbo', 2, 2018),
    (71, 'Portal', 8, 2007),
    (
        19456,
        'Ori
and the Blind Forest: Definitive Edition',
    ...
    (943, 'Colin McRae: Dirt', 2, 2007),
    (424, 'Resident Evil', 13, 1996),
    (9730, 'Firewatch', 14, 2016);
...
VALUES
    ...
    (1, 482, 8, '2017/2/14', FALSE),
    (1, 8222, 8, '2017/3/6', FALSE),
    (1, 7334, 11, '2017/4/1', FALSE),
